/*====================================================
	...
	cnx.claude@free.fr, Florent Hirchy, Váry Péter,
		...
		{// checks if row has exact cell #
			...
			for(var j=0; j<nchilds; j++)// this loop retrieves cell data
			{
				if((cellIndex==j && !isRefreshed) || (cellIndex==j && isRefreshed && row[k].style.display == ""))
				{
					...
					var cell_string = cell_data.tf_MatchCase(this.matchCase).tf_Trim();//Váry Péter's patch
			...
			{// this loop retrieves cell data
				...
				if(this.searchArgs[j]!="")
				{
					...
					{						
						...
						if(this.exactMatch || f["col_"+j]=="select")//Váry Péter's patch
